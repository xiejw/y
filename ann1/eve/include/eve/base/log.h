...
// -----------------------------------------------------------------------------
#define logTrace( ... )                                             \
        eve::base::loge_( eve::base::LOG_TRACE, __FILE__, __LINE__, \
                          __VA_ARGS__ )
#define logDebug( ... )                                             \
        eve::base::loge_( eve::base::LOG_DEBUG, __FILE__, __LINE__, \
                          __VA_ARGS__ )
#define logInfo( ... ) \
...
#define logError( ... )                                             \
        eve::base::loge_( eve::base::LOG_ERROR, __FILE__, __LINE__, \
                          __VA_ARGS__ )
#define logFatal( ... )                                             \
        eve::base::loge_( eve::base::LOG_FATAL, __FILE__, __LINE__, \
                          __VA_ARGS__ )
