...
extern void vmOpsToSds(_mut_ sds_t *psds, size_t size, const struct vm_oparg *);
extern error_t vmBatch(struct vm *vm, size_t arg_size, const struct vm_oparg *);
...
#define VM_VR3S(vm, s1, s2, s3) vmSpNew(vm, 3, (int[]){(s1), (s2), (s3)})
