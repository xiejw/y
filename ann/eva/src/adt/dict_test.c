...
test_add_and_find()
{
        ...
        dictSetU64(en, 123);
        ASSERT_TRUE("val", dictGetU64(dictFind(t, VDATA("abc"))) == 123);
        ASSERT_TRUE("val null", NULL == dictFind(t, VDATA("bc")));
...
test_delete()
{
        ...
        ASSERT_TRUE("del", 0 == dictDelete(t, VDATA("abc")));  // not found
...
test_add_and_find_existed()
{
        ...
        ASSERT_TRUE("same val", dictGetU64(dictFind(t, VDATA("abc"))) == 123);
        dictFree(t);
        return NULL;
}
...
test_sds_key_str_val()
{
        ...
        ASSERT_TRUE("val",
                    0 == strcmp(dictGetData(dictFind(t, VDATA("abc"))), "123"));
        ASSERT_TRUE("val null", NULL == dictFind(t, VDATA("bc")));

        // replace existing
        ASSERT_TRUE("replcae", 0 == dictReplace(t, VDATA("abc"), VDATA("456")));
        ASSERT_TRUE("new val",
                    0 == strcmp(dictGetData(dictFind(t, VDATA("abc"))), "456"));

        // replace new
        ASSERT_TRUE("replcae", 1 == dictReplace(t, VDATA("bc"), VDATA("789")));
        ASSERT_TRUE("val replaced",
