...
test_empty_str( void )
{
        ...
        ASSERT_TRUE( "digest",
                     0 == strcmp( "e3b0c44298fc1c149afbf4c8996fb92427ae"
...
test_str( void )
{
        ...
        ASSERT_TRUE( "digest",
                     0 == strcmp( "0f78fcc486f5315418fbf095e71c0675ee07"
...
test_str_padding_one_more( void )
{
        ...
        ASSERT_TRUE( "digest",
                     0 == strcmp( "5e4084eff2f37d637e6502bf9472b0029755"
...
test_long_str( void )
{
        sds_t sds = sha256DigestStr(
            ...
            "efficiency." );
        ASSERT_TRUE( "digest",
                     0 == strcmp( "2c2ca89ccbfa44169a32172be34361b85050"
