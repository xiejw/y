...
#define CASE_ELEWISE_OP( OP, API )                                        \
        case VM_OP_##OP:                                                  \
                ...
                return errNewWithNote(                                    \
                    ENOTIMPL, "unimpl forVM_OP_" #OP " with dtype %d",    \
                    td->dtype );
...
#undef CASE_ELEWISE_OP
        ...
        case VM_OP_MATMUL:
                ...
                if ( td->dtype == VM_F32 ) {
                        ...
                        return vmOpMatmulF32( td, t1, t2, trans_lhs,
                                              trans_rhs );
                }
        ...
        default:
                return errNewWithNote( ENOTIMPL, "unimpl op for vmExec: %d",
                                       op );
        }
}
